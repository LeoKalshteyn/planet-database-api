...
p3= Planet.create(label: "Epsilon Eridani b", planet_mass: "0.9", radius: "Missing Data", semimajor_axis: "0.047", orbital_period: "11.2", eccentricity: "0.02", discovery_year: "2016", star_id: 3 )
p4= Planet.create(label: "Ross 128 b", planet_mass: "0.9", radius: "Missing Data", semimajor_axis: "0.047", orbital_period: "11.2", eccentricity: "0.02", discovery_year: "2016", star_id: 4 )
p5= Planet.create(label: "Bb", planet_mass: "15.7", radius: "Missing Data", semimajor_axis: "0.261", orbital_period: "91.3", eccentricity: "0.06", discovery_year: "2019", star_id: 5 )
p6= Planet.create(label: "Bc", planet_mass: "13.1", radius: "Missing Data", semimajor_axis: "0.428", orbital_period: "192", eccentricity: "0.03", discovery_year: "2019", star_id: 5 )
p6= Planet.create(label: "Gliese 15 Ab", planet_mass: "3.6", radius: "Missing Data", semimajor_axis: "0.0710", orbital_period: "11.4", eccentricity: "0.071", discovery_year: "2014", star_id: 6 )
