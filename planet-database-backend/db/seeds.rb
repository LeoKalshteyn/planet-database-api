...
p1= Planet.create(label: "Proxima b", information: "test", star_system_id: 1 )
p2= Planet.create(label: "GJ 699 b", information: "test", star_system_id: 2 )
p3= Planet.create(label: "Epsilon Eridani b", information: "test", star_system_id: 3 )
p4= Planet.create(label: "Ross 128 b", information: "test", star_system_id: 4 )
